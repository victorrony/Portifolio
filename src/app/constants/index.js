...
const technologies = [
  { name: "React JS", icon: "/assets/tech/reactjs.png", level: 90 },
  { name: "TypeScript", icon: "/assets/tech/typescript.png", level: 82 },
  { name: "Tailwind CSS", icon: "/assets/tech/tailwind.png", level: 88 },
  { name: "Node JS", icon: "/assets/tech/nodejs.png", level: 78 },
  { name: "MySQL", icon: "/assets/tech/mysql.png", level: 72 },
  { name: "Three JS", icon: "/assets/tech/Threejs.png", level: 65 },
  { name: "Motion", icon: "/assets/tech/motion.png", level: 80 },
];

// Ferramentas utilizadas
const tools = [
  { name: "VS Code", icon: "/assets/tech/vscode.jpeg", level: 95 },
  { name: "Postman", icon: "/assets/tech/postman.jpeg", level: 85 },
  { name: "Vercel", icon: "/assets/tech/vercel.png", level: 88 },
  { name: "Figma", icon: "/assets/tech/figma.png", level: 70 },
  { name: "git", icon: "/assets/tech/git.png", level: 85 },
  { name: "GitHub", icon: "/assets/github.png", level: 88 },
];
...
const projects = [
  ...
  },
  {
    ...
    description:
      "A multi-page website that showcases space tourism and enables users to book a trip to space.",
    tags: [
      {
        name: "Nextjs",
        color: "blue-text-gradient",
  ...
  },
  {
    name: "Chat GPT clone",
    description:
      "A clone of the ChatGPT website that enables users to chat with an AI-powered chatbot.",
    tags: [
      {
        name: "Nextjs",
        color: "blue-text-gradient",
  ...
  },
  {
    ...
    description:
      "A web application that enables users to create and view a list of people and cities.",
    tags: [
      {
        name: "React",
        icon: "/assets/tech/reactjs.png",
      ...
      },
      {
        ...
        icon: "/assets/tech/typescript.png",
        descricao:
          "Linguagem de programação para criar aplicações web escaláveis",
      },
      {
        name: "Node.js",
        icon: "/assets/tech/nodejs.png",
    ...
    source_code_link:
      "https://github.com/victorrony/Listagem-de-Pessoas-e-Cidades-FrontEnd",
