...
export default function Hero() {
   return (
      <header className="relative w-full h-full flex flex-col items-start justify-center md:w-full lg:w-full xl:w-[1280px]">
         <div className=" flex flex-row items-start justify-center w-full gap-10 mt-20 lg:gap-20 xl:gap-10">
            ...
            <div className="flex flex-col items-center justify-center gap-7">
               <h2 className="text-2xl font-sans lg:text-3xl text-white">
                  Hi, my name is <span className="font-bold font-serif">Victor Rony.</span> I'm
               </h2>
