export const metadata = {
   ...
   description:
      "Desenvolvedor Full Stack apaixonado por tecnologia, especializado em React, Next.js, Node.js e design responsivo. Explore meus projetos e experiências.",
   keywords: [
      "Victor Fernandes",
   ...
   openGraph: {
      ...
      description:
         "Desenvolvedor Full Stack especializado em React, Next.js e Node.js. Veja meus projetos e experiências.",
      images: [
         {
            url: "/og-image.jpg",
            width: 1200,
            ...
            <script
               ...
               dangerouslySetInnerHTML={{
                  __html: JSON.stringify({
                     ...
                     knowsAbout: ["JavaScript", "React", "Next.js", "Node.js", "TypeScript", "Full Stack Development"],
                  }),
               }}
            />
         </head>
